...
PACKAGE := do_i_need_to_upgrade
PYTHON_TARGETS := do_i_need_to_upgrade tests
PYLINT_MAIN_TARGETS := do_i_need_to_upgrade
...
ABOUT_FILE := do_i_need_to_upgrade/__about__.py
